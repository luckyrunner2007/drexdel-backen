/**
 * PROJECT DREXDEL - FOLLOWERS LIST SCREEN
 * FILE: src/screens/Social/FollowersListScreen.tsx
 */
...
export const FollowersListScreen: React.FC = () => {
  ...
  const load = useCallback(async (cursor?: string) => {
    setLoading(true);
    const res = await userApi.getFollowers(userId, cursor);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>People following {userName}</Text>
